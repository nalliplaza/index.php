...
<footer style="background-color: #393939;">
	...
	<div class="col-sm-4 hov">
		<img src="logo/logo3.png"width="200px"height="200px"/><br><br>
...
?>
	...
	<div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Address:&nbsp;</strong>Near Manipal Hospital,Vellkkalpatti,Omalur Main road,Salem-12</p>
      <p style="color:white;"><strong>&nbsp;</strong></p>
      <p style="color:white;"><strong>Contact Us:&nbsp;</strong>(+91) 7845275777</p><br><br><br>
