    ...
    <div class="col-md-4">
      <div class="thumbnail">
        <a href="image/image gallery/8.jpg" target="_blank">
          <img src="image/image gallery/8.jpg" alt="img3 Not Show" style="width:100%;height:160px;">
        </a>
      </div>
    </div>
    <div class="col-md-4">
    ...
    <div class="col-md-4">
      <div class="thumbnail">
        <a href="image/image gallery/9.jpg" target="_blank">
          <img src="image/image gallery/9.jpg" alt="img3 Not Show" style="width:100%;height:160px;">
        </a>
      </div>
    </div>
    <div class="col-md-4">
